    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        potvrdi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FirebaseDatabase.getInstance("https://myapplication-6ee26-default-rtdb.europe-west1.firebasedatabase.app/")
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for(DataSnapshot snap: snapshot.getChildren()){
                            ...
                            FirebaseDatabase.getInstance("https://myapplication-6ee26-default-rtdb.europe-west1.firebasedatabase.app/").getReference("Aktivnosti").child(snap.getKey()).updateChildren(mapNaracka);
                        }
                    }
                ...
                FirebaseDatabase.getInstance("https://myapplication-6ee26-default-rtdb.europe-west1.firebasedatabase.app/").getReference("Users").orderByChild("email").equalTo(emailVolonter).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for(DataSnapshot snap: snapshot.getChildren()){
                ...
                startActivity(new Intent(VolunteerDescription.this,ListActivities.class));
            }
        });
    }
}